...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_provider_job_status",
        "provider_jobs",
        ["provider_id", "status"],
        unique=False,
    )
    op.create_index(
        "idx_provider_job_user",
        "provider_jobs",
        ["user_id", "created_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_provider_jobs_user_id"), "provider_jobs", ["user_id"], unique=False
    )
    op.create_table(
        "provider_pings",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        "idx_ping_provider_date",
        "provider_pings",
        ["provider_id", "pinged_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_provider_pings_id"), "provider_pings", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_provider_pings_provider_id"),
        "provider_pings",
        ["provider_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_provider_verifications_id"),
        "provider_verifications",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_provider_verifications_provider_id"),
        "provider_verifications",
        ["provider_id"],
        unique=False,
    )
    op.add_column(
        "users", sa.Column("unsubscribe_token", sa.String(length=36), nullable=True)
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_provider_verifications_provider_id"),
        table_name="provider_verifications",
    )
    op.drop_index(
        op.f("ix_provider_verifications_id"), table_name="provider_verifications"
    )
